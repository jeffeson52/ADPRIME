  ...
  <div class="content">
    ...
    <?php
      ...
      if ($resultado = mysql_fetch_array($consulta)){
        ...
        <div>
        <?php echo "<a href='session_id_user.php?id=".$resultado['id_usuario'] . " ' "; ?><a class="popupbt">Enviar</a>
        <?php echo "<a href='arquivos_enviados_adm.php?id=".$resultado['id_usuario'] . " ' "; ?><a class="popupbt">Enviados</a>
        </div>
