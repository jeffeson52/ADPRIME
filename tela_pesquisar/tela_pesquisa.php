...
<body>
  ...
  <div class="content">
    ...
    <h2>Pesquisar pelo nome do usuários - <a class='resultado_contador' style='text-decoration:none; color:black;'></a></h2>
		<form method="POST" id="form-pesquisa" action="">
			<label>Pesquisar: </label>
			<input type="text" name="pesquisa" id="pesquisa" placeholder="Digite o nome do usuário">
		</form>
    
    <a href='' class='resultado' style='text-decoration:none; color:black;'></a></br></br>
    ...
    <script type="text/javascript" src="contador_user.js"></script>
		...
		<form method="POST" id="form-pesquisa" action="gerar_exel_nome.php">
			<label>Pesquisar: </label>
			<input type="text" name="pesquisa_nome" id="pesquisa_nome" placeholder="Digite o nome do usuário"><button type="submit">Gerar Excel</button>
		</form></br>
<!------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
    <div id="divisaorodape">&nbsp;</div>

    <h2>Pesquisar por cidade - <a class='contador_regiao' style='text-decoration:none; color:black;'></a></h2>
		<form method="POST" id="form-pesquisa" action="">
			<label>Pesquisar: </label>
			<input type="text" name="pesquisa_regiao" id="pesquisa_regiao" placeholder="Digite a cidade">
		</form>

    <a href="" class="resultado_regiao" style="text-decoration:none; color:black;"></a></br></br>
    ...
    <form method="POST" id="form-pesquisa" action="gerar_exel_cidade.php">
			<label>Pesquisar: </label>
			<input type="text" name="pesquisa_cidade" id="pesquisa_cidade" placeholder="Digite a cidade"><button type="submit">Gerar Excel</button>
		</form></br>
<!------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
    <div id="divisaorodape">&nbsp;</div>

    <h2>Pesquisar por estado - <a class='contador_estado' style='text-decoration:none; color:black;'></a></h2>
		<form method="POST" id="form-pesquisa" action="">
			<label>Pesquisar: </label>
			<input type="text" name="pesquisa_estado" id="pesquisa_estado" placeholder="Digite o estado">
		</form>

    <a href="" class="resultado_estado" style="text-decoration:none; color:black;"></a></br></br>
    ...
    <form method="POST" id="form-pesquisa" action="gerar_exel_estado.php">
			<label>Pesquisar: </label>
			<input type="text" name="pesquisa_estado" id="pesquisa_estado" placeholder="Digite a cidade"><button type="submit">Gerar Excel</button>
		</form></br>
<!------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
    <div id="divisaorodape">&nbsp;</div>
