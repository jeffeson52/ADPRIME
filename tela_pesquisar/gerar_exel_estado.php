...
<html lang="pt-br">
    ...
    <body>
		...
		if(isset($_POST['pesquisa_estado'])){
			$pesquisa_estado = addslashes($_POST['pesquisa_estado']);
		}
        ...
        WHERE e.estado LIKE '%$pesquisa_estado%' 
        AND u.id_usuario != '$id_usuario' AND t.fk_id_usuario != '$id_usuario' AND e.fk_id_usuario != '$id_usuario' AND d.fk_id_usuario != '$id_usuario' ";
